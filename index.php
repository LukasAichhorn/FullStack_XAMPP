...
console.log("hello");
 ...
 <!-- lightbox  CSS -->
 <link href="./ressources/plugins/lightbox2-2.11.3/src/css/lightbox.css" rel="stylesheet" />
...
<body>
  ...
  <div class="row">
    ...
    -->
    <!-- lightbox JS -->
    <script src="./ressources/plugins/lightbox2-2.11.3/src/js/lightbox.js"></script>
