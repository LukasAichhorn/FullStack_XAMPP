    ...
    //if img name = default => use default path
    $RD = $DB->getUserRootByID($Post->UserID);
    $RD = $RD[0];
                ...
                <div class="card-body d-flex flex-row flex-wrap h-100">
                    <div class="row w-100">
                        <div class="col">
                            ...
                            <p class="d-flex"><small> <?php /*Shorthand für dynamische Anzeige */echo ($Post->Sichtbarkeit == 0) ? "privat" : "öffentlich"; ?></small></p>
                                    ...
                                    <div class="d-flex flex-row justify-content-end">
                                        ...
                                        <div class="Comp-like">
                                            <form action="//<?php echo (DIR_UTIL); ?>handleLikes.php">
                                                ...
                                                <input type="hidden" name="PostId" value="<?php echo ($Post->PostID); ?>" />
                                                <button type="submit" class="btn btn-sm btn-sm-my btn-outline-danger" <?php echo (empty($CurrentUser) == TRUE) ? "disabled" : "" ?>> <?php echo ($Post->Dislikes); ?> </button>
                                            </form>
                                        </div>
